 ...
 *
 * @Block(
 *   id = "foromenu_tags_block",
 *   admin_label = @Translation(" Foromenu_tags Block"),
 *   category = @Translation("Foromenu_tags block")
 * )
 */
class foromenu_tags extends BlockBase {
