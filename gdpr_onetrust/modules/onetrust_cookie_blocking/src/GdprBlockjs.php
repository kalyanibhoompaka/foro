...
class GdprBlockjs {
   ...
   *  / ONETRUST_COOKIE_BLOCKING_TARGETTING / ONETRUST_COOKIE_BLOCKING_MEDIA
   * @param $position
   ...
   * @param INT $groupid
   *  The OneTrust Cookie Category values
   *  ONETRUST_COOKIE_BLOCKING_PERFORMANCE/ONETRUST_COOKIE_BLOCKING_FUNCTIONAL/ONETRUST_COOKIE_BLOCKING_TARGETTING/ONETRUST_COOKIE_BLOCKING_MEDIA
   * @param array $additional
   *  Array consisting of 3rd and 4th parameter of Optanon.InsertHTML()
   *  Optional
